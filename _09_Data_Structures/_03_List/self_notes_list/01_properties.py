...
List properties:
==================
# 1. List will allow both homogeneous and hetrogenous
...
list_1 = [1, 1.5, True, 'HelloWorld', 234]
"""       0   1    2       3           4   """
# Indexing

print("List_1 is : ", list_1)

print("Indexing : ", list_1)

print("Indexing : ", list_1[1])

print("Indexing : ", list_1[3], list_1[-2])

print("Get o in list1 :", list_1[3], list_1[3][4])
