...
madhu = Employee(100)
print("Madhu object :", madhu)  # 0_sir_notes.__str__()
...
class Employee(object):
    pass
madhu = Employee
print("0_sir_notes str : ",madhu)  # 0_sir_notes.__str__()
...
print("0_sir_notes str :",madhu)
print("0_sir_notes str :",str(madhu))
print("0_sir_notes repr:",repr(madhu))
