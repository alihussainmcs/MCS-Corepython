...
# 0_sir_notes = Employee(10,'Madhu N',20000)
'''
inx x = 10                        x = 10
String message = "Hello World"    message = "Hello World"
Employee 0_sir_notes = Employee(...)    0_sir_notes = Employee(...)
...
'''
x = 10    =Java=> int x = 10
             0_sir_notes = Employee(100,'MadhuN',1000)
    Employee 0_sir_notes = new  Employee(100,'MadhuN',1000)
...
1. Employee 0_sir_notes = Employee(100,'Madhu',2000)
2. SEmployee 0_sir_notes = SEmployee(100,'Madhu',2000)
3. Employee 0_sir_notes = SEmployee(100,'Madhu',2000)  # Upcasting


4. SEmployee 0_sir_notes = Employee(100,'Madhu',2000)  # Downcasting X
