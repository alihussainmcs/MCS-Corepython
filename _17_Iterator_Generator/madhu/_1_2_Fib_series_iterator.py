...
myIterator = mylist.__iter__()  # myIterator is a list iterator object.
...
once an iterator runs out of things to return from the next function it raises the StopIteration exception whenever next
is called
'''
...
Finally,
You can write for loops for iterating over many kinds of Python's build in iterables and, if that's not enough, you can 
even make your own iterables.
'''
