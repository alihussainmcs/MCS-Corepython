...
-> DDL Commands
-> DML Commands
-> Create new table using existing table in db with same table structure
...
INSERT INTO students_table VALUES(100103,'Swoop','CSE');
...
--How to create the new table with same structure of existing table in db without records?
