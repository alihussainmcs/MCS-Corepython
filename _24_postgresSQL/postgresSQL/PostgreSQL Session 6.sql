...
4) display dname,loc whose dname does't contain employees
SELECT
 d1.dname,d1.loc
FROM
dept d1
...
where e1.deptno = d1.deptno
AND sal >=3000
6) display ename,job,sal whose sal is greater than average sal of employees(Using Subquery)
...
insert into employee(id,name,empno) values(103,'Deepak',1001);
insert into employee(id,name,empno) values(103,'Deepak',1002);
