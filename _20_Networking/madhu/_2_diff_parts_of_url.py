...
-------------------------------------------
GET  - to retrieve data from server     --- "My Orders" Amazon
                                            SignIn POST(Security reasons)
...
# 1. Request URL
import urllib.parse
url = "https://www.google.com/search?q=networking+layers+osi+model&rlz=1C1CHBF_enIN835IN835&sxsrf" \
      "=ALeKk00dGqHArXquUobMFYDOxdbP70oLyA:1612842660470&tbm=isch&source=iu&ictx=1&fir=Bd81XnzZHgtTUM" \
      "%252CF2v0ZXThlQYD6M%252C_&vet=1&usg=AI4_-kQeiCZ0WfIXRJx3r0ep8aDwX_M76A&sa=X&ved" \
      "=2ahUKEwj7hOyO89vuAhXmxDgGHQdEDQ4Q9QF6BAgLEAE&biw=1517&bih=694#imgrc=hYHggnMXACIXNM "
...
--------------------------
GET -- for data retrieval      --- R RETRIEVAL
POST -- to save data           --- C CREATE
PUT --- to update the record   --- U UPDATE
DELETE --- to delete the record -- D DELETE
